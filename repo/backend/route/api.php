...
})->middleware(['auth', 'org_isolation'])->middleware('rbac', 'governance.view_dashboard');

// ─── Audit (admin) ──────────────────────────────────────────────────────────
Route::group('api/audit', function () {
    Route::get('logs', 'AuditController/index');
})->middleware(['auth', 'org_isolation'])->middleware('rbac', 'audit.read');
...
})->middleware(['auth', 'org_isolation'])->middleware('rbac', 'user.manage');
